...
namespace Sparta_TextRPG
{
    public class Skill
    {
        ...
        public float Damage { get; set; }     //스킬 대미지(퍼센테이지로 적용,표기시 유의)
        public int Mana {  get; set; }      //마나 소모량
        public int Level { get; set; }      //스킬 레벨
        public int CoolTime { get; set; }   //스킬 쿨타임
        public int NowCoolTime { get; set; }   
        public int TargetCount { get; set; }
        public Skill(string name, int criticalRate, string text, float damage, int mana, int level, int coolTime, int targetCount)
        {
            Name = name;
